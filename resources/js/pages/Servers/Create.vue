    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-semibold text-gray-900 dark:text-gray-100">Create Server</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Add a new server to your infrastructure</p>
                </div>
            ...
            <div class="overflow-hidden rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800">
                <Form action="/servers" method="post" #default="{ errors, processing }" class="p-8">
                    <div class="space-y-8">
                        <!-- Basic Information -->
                        <div class="space-y-6">
                            <div>
                                ...
                                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Input id="name" name="name" type="text" required placeholder="e.g., web-server-01" class="w-full" />
                                    ...
                                    <div class="space-y-2">
                                        ...
                                        <Input id="ip_address" name="ip_address" type="text" required placeholder="192.168.1.100" class="w-full" />
