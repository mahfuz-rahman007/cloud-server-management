  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="flex h-full flex-1 flex-col gap-6 p-6">
      ...
      <div
        ...
        <Form :action="`/servers/${props.server.id}`" method="put" #default="{
            errors,
            hasErrors,
            processing,
            wasSuccessful,
          ...
          <div v-if="errors.updated_at" class="rounded-md bg-red-50 p-4 border border-red-200 dark:bg-red-900/20 dark:border-red-800 mb-3">
            <div class="flex">
              ...
              <div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  <div class="space-y-2">
                    ...
                    <Input id="name" name="name" type="text" required :model-value="props.server.name"
                      placeholder="e.g., web-server-01" class="w-full" />
                  ...
                  <div class="space-y-2">
                    ...
                    <Input id="ip_address" name="ip_address" type="text" required :model-value="props.server.ip_address"
                      placeholder="192.168.1.100" class="w-full" />
                  ...
                  <div class="space-y-2">
                    ...
                    <select id="provider" name="provider" required :value="props.server.provider"
                      ...
                      <option value="digitalocean" :selected="props.server.provider === 'digitalocean'">DigitalOcean
                      </option>
                  ...
                  <div class="space-y-2">
                    ...
                    <select id="status" name="status" required :value="props.server.status"
                      class="w-full h-9 px-3 py-1 text-sm rounded-md border border-input bg-transparent shadow-xs transition-[color,box-shadow] outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] dark:bg-input/30">
