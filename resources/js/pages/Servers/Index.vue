...
// Computed values
const hasFilters = computed(() => search.value || statusFilter.value || providerFilter.value);
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Servers</h1>
                    <p class="text-sm text-gray-600 dark:text-gray-400">Manage your cloud servers across different providers</p>
                </div>
            ...
            <!-- Filters -->
            <div class="flex flex-wrap gap-6 rounded-lg border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
                <div class="min-w-72 flex-1">
                    ...
                    <div class="relative">
                        ...
                        <input
                            ...
                            class="block w-full rounded-md border-gray-300 py-2.5 pr-4 pl-10 shadow-sm transition-colors duration-200 focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                        />
                    </div>
                </div>
                ...
                <div class="min-w-40">
                    ...
                    <select
                        ...
                        @change="applyFilters"
                        class="block w-full cursor-pointer rounded-md border-gray-300 px-3 py-2.5 shadow-sm transition-colors duration-200 focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                    >
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                ...
                                <th
                                    @click="sort('name')"
                                    class="group cursor-pointer px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase transition-all duration-200 select-none hover:bg-gray-100 hover:text-gray-700 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-gray-100"
                                >
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <ArrowUpDown v-else class="h-3 w-3 opacity-50 transition-opacity group-hover:opacity-100" />
                                        </div>
                                    </div>
                                </th>
                                <th
                                ...
                                >
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <ChevronDown
                                                v-else-if="sortField === 'ip_address' && sortDirection === 'desc'"
                                ...
                                >
                                    <div class="flex items-center gap-2">
                                        ...
                                        <div class="flex flex-col">
                                            ...
                                            <ChevronDown
                                                v-else-if="sortField === 'provider' && sortDirection === 'desc'"
                                                class="h-3 w-3 text-blue-500"
                                            />
                                            <ArrowUpDown v-else class="h-3 w-3 opacity-50 transition-opacity group-hover:opacity-100" />
                                        </div>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase dark:text-gray-300">
                                    <div class="flex flex-col">
                                        <span>Resources</span>
                                        <span class="text-xs font-normal text-gray-400 normal-case">CPU • RAM • Storage</span>
                                    </div>
                                </th>
                                <th class="px-6 py-3 text-left text-xs font-medium tracking-wider text-gray-500 uppercase dark:text-gray-300">
                                    Actions
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                            <tr v-for="server in props.servers.data" :key="server.id" class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="text-sm text-gray-900 capitalize dark:text-gray-100">{{ server.provider }}</div>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <Badge
                            ...
                            <div class="flex items-center space-x-1">
                                <template v-for="page in getVisiblePages" :key="page">
                                    ...
                                    <Button
                                        ...
                                        size="sm"
                                        @click="goToPage(page)"
                                        class="min-w-[32px] cursor-pointer"
                                    >
                                        {{ page }}
                                    </Button>
                                </template>
            ...
            <!-- Empty State -->
            <div v-if="props.servers.data.length === 0" class="py-12 text-center">
            ...
            <Dialog v-model:open="deleteDialogOpen">
                <DialogContent class="sm:max-w-md">
                    ...
                    <DialogFooter class="gap-3">
                        <Button variant="outline" @click="deleteDialogOpen = false" :disabled="isDeleting" class="cursor-pointer"> Cancel </Button>
            ...
            <Dialog v-model:open="bulkDeleteDialogOpen">
                <DialogContent class="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Are you sure you want to delete {{ selectedServers.length }} selected servers? This action cannot be undone.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter class="gap-3">
            ...
            <Dialog v-model:open="bulkStatusDialogOpen">
                <DialogContent class="sm:max-w-md">
                    <DialogHeader>
                        ...
                        <DialogDescription> Update the status for {{ selectedServers.length }} selected servers. </DialogDescription>
                    </DialogHeader>
                    <div class="py-4">
                        <select
                            v-model="bulkStatusValue"
                            class="block w-full cursor-pointer rounded-md border-gray-300 px-3 py-2 shadow-sm transition-colors duration-200 focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100"
                        >
